export class PreloaderScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image('bg10', './assets/backgrounds/game-bg10.png')
     ...
     this.load.svg('ship-healthbar-bar', './assets/healthbar/ship-healthbar-bar.svg')
     this.load.svg('ship-healthbar-starter', './assets/healthbar/ship-healthbar-starter.svg')
     this.load.svg('ship-healthbar-container', './assets/healthbar/ship-healthbar-container.svg')
